...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            console.log(vm.StudentLeave.beginTime)
            if (vm.StudentLeave.beginTime === '' || undefined === vm.StudentLeave.beginTime) {
                alert("请选择开始时间")
                return;
            }
            if (vm.StudentLeave.endTime === '' || undefined === vm.StudentLeave.endTime) {
                alert("请选择结束时间")
                return;
            }
            var url = vm
