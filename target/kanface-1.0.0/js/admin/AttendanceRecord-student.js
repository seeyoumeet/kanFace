$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {
                label: '所属老师',
                name: 'teacherEntity.username',
                index: 'teacherEntity.username',
                width: 80
            },
            {
                label: '被考核学生',
                name: 'studentEntity.username',
                index: 'studentEntity.username',
                width: 80
            },
            {
                label: '上课考勤状态',
                name: 'startclassStatus',
                index: 'startclassStatus',
